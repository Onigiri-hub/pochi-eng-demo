    ...
    <div className="container">
      <div className="mainContent">
        ...
        <div style={{ fontSize: "14px", lineHeight: "1.8", color: "#333", marginTop: "70px", padding: "0 10px" }}>
          ...
          <p>本デモ版では、サーバーへの情報送信は行いません。</p>
          <p>学習記録はお使いのブラウザのlocalStorageにのみ保存されます。</p>
          ...
          <p>デモ版ではデータはブラウザのlocalStorageで管理されます。</p>
          <p>ブラウザのデータを消去すると、学習記録も削除されます。</p>

          <h3 style={{ fontSize: "16px", borderBottom: "1px solid #eee", paddingBottom: "5px", marginTop: "20px" }}>第4条（第三者サービス）</h3>
          <p>本デモ版では、外部サービスへのデータ送信は行いません。</p>

          <h3 style={{ fontSize: "16px", borderBottom: "1px solid #eee", paddingBottom: "5px", marginTop: "20px" }}>第5条（お問い合わせ）</h3>
